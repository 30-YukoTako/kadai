...
$sql = "SELECT * FROM news_list ORDER BY create_date DESC LIMIT 5";
...
//	echo '<dd class="news-description"><a href="news.php?news_id='.$row["news_id"] .'">' .$row["news_title"] . '</a></dd>';
	echo '<dd class="news-description"><a href="news.php?news_id=' . $row["news_id"] . '">' .$row["news_title"] . '</a>';
}
$pdo = null;
?>
